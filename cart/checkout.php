			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<select name="card_bank" id="card_bank" class="form-control">
						...
						<option value="Bank BCA" <?php echo isset($A); ?>>Bank BCA</option>
						<option value="Bank Mandiri" <?php echo isset($B); ?>>Bank Mandiri</option>
						<option value="Bank BNI" <?php echo isset($C); ?>>Bank BNI</option>
						<option value="Bank BRI" <?php echo isset($D); ?>>Bank BRI</option>
					</select>
