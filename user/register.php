					...
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<select name="gender" class="form-control">
								...
								<option value="Laki-laki" <?php echo isset($A); ?>>Laki-laki</option>
								<option value="Perempuan" <?php echo isset($B); ?>>Perempuan</option>
							</select>
							<span class="text-danger msg-error"><?php echo isset($genderErr); ?></span>
						</div>
					</div>
					<div class="row">
